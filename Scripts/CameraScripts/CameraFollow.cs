...
public class CameraFollow : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        current_Rotation = transform.eulerAngles.y;  // access the roatation

        current_Height = Mathf.Lerp(transform.position.y, target_Height, 0.9f * Time.deltaTime); //linealy goes to point a to b with speed
